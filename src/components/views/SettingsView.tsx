      ...
      <div className="settings-shell">
        ...
        <section className="settings-card">
          ...
          <div className="shortcut-grid">
            ...
            <div className="shortcut-row"><span>Rename / edit selected source</span><span className="kbd">⌘E</span></div>
            <div className="shortcut-row"><span>Duplicate selected source</span><span className="kbd">⌘D</span></div>
            <div className="shortcut-row"><span>Delete selected source</span><span className="kbd">⌘⌫</span></div>
          </div>
        </section>
